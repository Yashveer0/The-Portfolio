...
// filtering all the data from the API
    ...
    return (
        <> <div className='bg-black'>
            <Header name={user.about.name} avatarUrl={user.about.avatar.url} />
            <Hero title={user.about.title} subTitle={user.about.subTitle}  />
            <About user={user} />
            ...
            <Contact />
            < CustomCursor />
            <Socal socialHandles={user.social_handles} />
            </div>
        </>
    );
}
